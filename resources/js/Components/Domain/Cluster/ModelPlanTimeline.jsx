                    ...
                    <div className="flex items-start gap-3 sm:gap-4">
                        ...
                        <div className="flex-1 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 p-4 sm:p-5 border border-primary/10">
                            <h4 className="font-bold text-base sm:text-lg mb-2">
                                <a
                                    href={`https://www.google.com/search?q=${encodeURIComponent(item.spot_name)}`}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-accent hover:text-ocean transition-colors duration-200 inline-flex items-center gap-1 group"
                                >
                                    {item.spot_name}
                                    <svg
