...
- **企画書**: [`documents/proposal.md`](/documents/1_proposal.md)
- **DB設計書**: [`documents/DB_DesignDocument.md`](documents/2_DB_DesignDocument.md)
...
- **ER図**や各テーブルの詳細は、[DB設計書](documents/2_DB_DesignDocument.md)を参照してください。
